    ...
    <main class="calendar-app role-${esc(user.role)}">
      <header class="appbar">
        ...
        <div class="appbar-actions">
          ...
          ${String(user?.id || '') === '375938798' && user?.role === 'admin' ? '<a class="iconbtn soft admin-entry" href="/last-admin/" aria-label="Адмін-панель" title="Адмін-панель" data-admin-entry>⚙</a>' : ''}
